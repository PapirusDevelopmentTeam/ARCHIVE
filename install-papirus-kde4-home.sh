...
rm -rf ~/.kde/share/apps/aurorae/themes/{Papirus,Papirus-Transparent}
...
echo "Installing ..."
cp -R /tmp/papirus-aurorae-theme-master/{Papirus,Papirus-Transparent} ~/.kde/share/apps/aurorae/themes/
echo "Delete cache ..."
rm -rf /tmp/papiru*
echo "Done!"
